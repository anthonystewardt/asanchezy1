    ...
    <div class="w-full h-full flex justify-center items-center flex-col gap-3  ">
         <div class="xl:w-1/3 text-center mt-10 xl:mt-0 text-white">
            <div class="flex justify-center">
                <a href="{{ route('blog.index') }}" class="px-4 hover:bg-red-500 hover:text-white  transition ease-out py-2 flex items-center gap-3 text-orange-500  border-2  mb-10 border-orange-500 rounded-full text-sm">
